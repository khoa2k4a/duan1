...
public class SanPham_UI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblSanPhamChiTiet.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã SPCT", "Tên Sản Phẩm", "Loại SP", "Màu sắc", "Size", "Chất liệu", "Lượng tồn kho", "Đơn giá", "Trang Thái"
            }
        ));
        ...
        if (tblSanPhamChiTiet.getColumnModel().getColumnCount() > 0) {
            tblSanPhamChiTiet.getColumnModel().getColumn(1).setHeaderValue("Tên Sản Phẩm");
        }
    ...
    private void btnThemSPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemSPActionPerformed
        // TODO add your handling code here:
        ThongTinSP_UI tt = new ThongTinSP_UI();
        tt.setVisible(true);
