 ...
 * @author ADMIN
 */
public class LichSu_UI extends javax.swing.JFrame {

    private final LichSuService serLS = new LichSuService();
    private final HoaDonService serHD = new HoaDonService();
    ...
    private void initComponents() {
        ...
        txtTongTienLS = new javax.swing.JTextField();
        ...
        btnLichSu.setBackground(new java.awt.Color(204, 255, 255));
        ...
        tblHoaDon.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã HD", "Ngày tạo", "Mã NV", "Tên KH", "Mã giảm giá", "Trạng thái"
            }
        ) {
        ...
        pnThongTinLayout.setVerticalGroup(
            ...
            .addGroup(pnThongTinLayout.createSequentialGroup()
                ...
                .addGroup(pnThongTinLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(txtTongTienLS, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(pnThongTinLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        layout.setVerticalGroup(
            ...
            .addComponent(pnLichSu, javax.swing.GroupLayout.DEFAULT_SIZE, 701, Short.MAX_VALUE)
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LichSu_UI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
    ...
    private javax.swing.JTextField txtTongTienLS;
    private javax.swing.JTextField txtTrangThaiLS;
    // End of variables declaration//GEN-END:variables

    private void fillHD(List<HoaDon> lstHD) {
    ...
    private void fillSP(List<ChiTietHoaDon> lstSP) {
        mol = (DefaultTableModel) tblSanPham.getModel();
        mol.setRowCount(0);
        for (ChiTietHoaDon cthd : lstSP) {
            mol.addRow(new Object[]{
                cthd.getSp().getSp().getMaSP(),
    ...
    private void showData(int index) {
        txtMaNVLS.setText((String) tblHoaDon.getValueAt(index, 2));
        txtTenKHLS.setText((String) tblHoaDon.getValueAt(index, 3));
        HoaDon h= serHD.getHoaDon().get(index);
        txtTongTienLS.setText(String.valueOf(h.getTongTien()));
        txtNgayLapLS.setText(tblHoaDon.getValueAt(index, 1).toString());
        txtTrangThaiLS.setText(h.getTrangThai());
        txtHinhThucTTLS.setText(h.getHinhThuc());
        txtGhiChuLS.setText(h.getGhiChu());
    }
