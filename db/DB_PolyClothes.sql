...
GO
ALTER TABLE SANPHAM_CT ADD CONSTRAINT fk_spct_sanpham FOREIGN KEY (ID_SP) REFERENCES SANPHAM (ID);
ALTER TABLE SANPHAM_CT ADD CONSTRAINT fk_spct_loaisp FOREIGN KEY (ID_LoaiSP) REFERENCES LOAISANPHAM (ID);
ALTER TABLE SANPHAM_CT ADD CONSTRAINT fk_spct_mau FOREIGN KEY (ID_Mau) REFERENCES MAU (ID);
ALTER TABLE SANPHAM_CT ADD CONSTRAINT fk_spct_size FOREIGN KEY (ID_Size) REFERENCES SIZE (ID);
ALTER TABLE SANPHAM_CT ADD CONSTRAINT fk_spct_chatlieu FOREIGN KEY (ID_CL) REFERENCES CHATLIEU (ID);
ALTER TABLE SALE_CT ADD CONSTRAINT fk_saleCT_sale FOREIGN KEY (ID_Sale) REFERENCES SALE (ID);
ALTER TABLE SALE_CT ADD CONSTRAINT fk_saleCT_spct FOREIGN KEY (ID_SPCT) REFERENCES SANPHAM_CT (ID);
...
ALTER TABLE HOADON_CT ADD CONSTRAINT fk_hdct_spct FOREIGN KEY (ID_SPCT) REFERENCES SANPHAM_CT (ID);
